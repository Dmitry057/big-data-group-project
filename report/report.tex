...
Stage 1 --- PostgreSQL schema \& load  & 60\% & 10\% & 10\% & 20\% & 20 & \texttt{create\_tables.sql}, \texttt{build\_projectdb.py} \\
Stage 1 --- Sqoop \& HDFS warehouse    & 70\% & 10\% &  0\% & 20\% & 16 & \texttt{import\_to\_hdfs.sh} \\
Stage 1 --- Storage benchmark          & 40\% & 40\% &  0\% & 20\% & 12 & \texttt{benchmark\_storage\_*}, CSVs \\
Stage 2 --- Hive warehouse setup       & 40\% & 20\% & 20\% & 20\% & 18 & \texttt{db.hql}, partitioned tables \\
Stage 2 --- 7 EDA queries              & 10\% &  0\% & 80\% & 10\% & 24 & \texttt{q1.hql} \dots \texttt{q7.hql} \\
Stage 2 --- EDA charts \& storytelling & 10\% &  0\% & 80\% & 10\% & 16 & \texttt{output/q*.jpg, q*.csv} \\
Stage 3 --- Feature pipeline           & 10\% & 75\% & 10\% &  5\% & 28 & \texttt{ml\_data\_preparation.py} \\
Stage 3 --- Model training \& CV       & 10\% & 80\% &  5\% &  5\% & 32 & \texttt{ml\_models\_training.py}, \texttt{models/} \\
Stage 3 --- Evaluation                 & 10\% & 60\% & 20\% & 10\% & 14 & \texttt{ml\_evaluation.py}, \texttt{evaluation.csv} \\
Stage 4 --- Superset dashboard         & 10\% & 10\% & 70\% & 10\% & 20 & Public dashboard \\
Pipeline orchestration (\texttt{main.sh}) & 50\% & 20\% & 10\% & 20\% & 16 & \texttt{main.sh}, \texttt{stage*.sh} \\
Repository documentation               & 10\% & 10\% & 10\% & 70\% & 14 & \texttt{README.MD}, \texttt{docs/} \\
Final report (this document)           &  5\% &  5\% & 10\% & 80\% & 40 & \texttt{report/report.pdf} \\
...
\small
\textit{Repository:}
\href{https://github.com/Dmitry057/big-data-group-project}%
{github.com/Dmitry057/big-data-group-project} \\
